...
func main() {
	...
	managerID := seedManager(ctx, usersCol, *phone, *password, *fullName)
...
func seedManager(ctx context.Context, usersCol *mongo.Collection, phone, password, fullName string) primitive.ObjectID {
